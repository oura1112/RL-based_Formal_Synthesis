...
%%%%%%%%%%%% Appendix A %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Proofs}
\input{proof_of_prop3_1}

\input{proof_of_lemma3_1}

\input{proof_of_thm3_1}
...
\begin{acknowledgement}
  ...
  I deeply appreciate Ami Sakakibara, Graduate school of Engineering Science, Osaka University, for fruitful comments and support.
