...
In \cite{Hahn2019,BWZP2019}, they use a non-generalized LDBA. However, when constructing an non-generalized LDBA from an LDBA, the order of visits to accepting sets of the LDBA is fixed. The construction causes the sparsity of the reward based on the acceptance condition of the non-generalized LDBA.
...
As a result, we can improve the sparsity of the rewards and learn a dynamic control policy that satisfies the LTL specification efficiently.
